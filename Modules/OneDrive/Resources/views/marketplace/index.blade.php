...
@php
    $path =  url("/Modules/OneDrive/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Discover the freedom of accessing your Onedrive files directly from Workdo-dash. No more switching between applications or dealing with cumbersome downloads. With this integration, your Onedrive documents, files, and folders are at your fingertips, effortlessly accessible within the Workdo-dash interface. Edit and view a wide range of file types – from Word documents to Excel spreadsheets, text files, and images – using the Viewer/Editor, all without the need to save files locally.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Seamless  ')}} <b>{{ __('Onedrive ') }}</b>{{ (' Integration')}}</h2>
                <p>{{__('Experience a new era of efficiency and collaboration with our cutting-edge Onedrive integration.')}}</p>
            </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Assign Onedrive Folders to Submodules')}}</h2>
                        </div>
                        <p>{{__('Unleash the full potential of collaboration and organization with our groundbreaking feature – the ability to seamlessly link Onedrive folders with submodules. With this innovative enhancement, Workdo-dash empowers you to synchronize your Onedrive documents with specific submodules, ensuring that your files are precisely where you need them. Whether you\'re managing projects, tasks, or any other submodule, this feature lets you effortlessly integrate your essential documents, images, and files.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Settings Page for Onedrive Integration')}}</h2>
                        </div>
                        <p>{{__('Streamline your tasks and boost productivity by seamlessly integrating Onedrive into Workdo-dash. Save your Onedrive credentials , choose submodules to enable, and enjoy direct access to your documents and files. Say goodbye to unnecessary app switching and cumbersome downloads – effortlessly edit and view various file types right within the Workdo-dash interface.')}}</p>
                    </div>
                </div>
            </div>
        </div>
